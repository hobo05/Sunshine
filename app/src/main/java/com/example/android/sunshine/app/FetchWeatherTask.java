...
//            }
    ...
    protected String[] doInBackground(String... params) {
        ...
        if (params.length != 3) {
            Log.e(LOG_TAG, String.format("Invalid number of parameters. Expected %d. 0) query 1) units 2) weatherServer", 3));
            return null;
        }
        String locationQuery = params[0];
        Units units = Units.valueOf(params[1]);
        WeatherServer weatherServer = WeatherServer.valueOf(params[2]);
